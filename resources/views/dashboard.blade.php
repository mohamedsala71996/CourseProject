                        ...
                        <div class="card-body">
                            <div class="direct-chat-messages">
                                <div class="direct-chat-msg">
                                    ...
                                    <img class="direct-chat-img" src="{{ asset('dist/assets/img/user1-128x128.jpg') }}" alt="message user image" />
                                ...
                                <div class="direct-chat-msg end">
                                    ...
                                    <img class="direct-chat-img" src="{{ asset('dist/assets/img/user3-128x128.jpg') }}" alt="message user image" />
                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user1-128x128.jpg') }}" alt="User Avatar" />
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user7-128x128.jpg') }}" alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Sarah Doe
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user3-128x128.jpg') }}" alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Nadia Jolie
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user5-128x128.jpg') }}" alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Nora S. Vans
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user6-128x128.jpg') }}" alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    John K.
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img" src="{{ asset('dist/assets/img/user8-128x128.jpg') }}" alt="User Avatar" />
                                            <div class="contacts-list-info">
                                                <span class="contacts-list-name">
                                                    Kenneth M.
